...
exports.default = {
  ...
  createColumnar: _columnar2.default
};
...
exports.default = function (content) {
  ...
  var createRadian = function createRadian(index, color) {
    svg.append('path').attr('d', d3.svg.arc().innerRadius(r - 10).outerRadius(r).startAngle(sr + index * st).endAngle(sr + (index + 1) * st)).attr('fill', color);
  };
...
exports.default = function (content) {
    ...
    return function (arg) {
        ...
        svg.transition().duration(500).select('g.axis-y').call(yAxis).selectAll('text').attr('fill', '#000').attr('stroke', 'transparent');
